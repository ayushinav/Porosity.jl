...
abstract type AbstractViscousModelDistribution <: AbstractRockphyModelDistribution end
...
mutable struct HZK2011Distribution{
    ...
    T5 <: Union{Distribution, AbstractArray}} <: AbstractViscousModelDistribution
    T::T1
    P::T2
    dg::T3
    σ::T4
...
mutable struct HK2003Distribution{
    ...
    T5 <: Union{Distribution, AbstractArray}, T6 <: Union{Distribution, AbstractArray}} <:
               AbstractViscousModelDistribution
    T::T1
    P::T2
    dg::T3
    σ::T4
